...
//		System.out.println(coffeeDto);
		...
		// 해쉬 코드는 같은 값을 넣었을 때 같은 결과가 나오는 코드이다
		// (비밀번호 등 해쉬 코드 알고리즘을 많이 사용한다)
//		System.out.println("coffee1의 모든 값을 통해 도출해낸 해쉬코드 값 : " 
//						+ coffee1.hashCode());
//		System.out.println("coffee2의 모든 값을 통해 도출해낸 해쉬코드 값 : " 
//				+ coffee2.hashCode());
//		System.out.println("coffee3의 모든 값을 통해 도출해낸 해쉬코드 값 : " 
//				+ coffee3.hashCode());
		
		log.info("coffee1의 모든 값을 통해 도출해낸 해쉬코드 값 : {}", coffee1.hashCode());
		log.info("coffee2의 모든 값을 통해 도출해낸 해쉬코드 값 : {}", coffee2.hashCode());
		log.info("coffee3의 모든 값을 통해 도출해낸 해쉬코드 값 : {}", coffee3.hashCode());
		
		// lombok이 구현해주는 equlas()는 두 객체의 hashCode()가 일치할 때 true를 반환한다
//		System.out.println("coffee1과 coffee2의 해쉬코드가 다르므로 다른 객체: " 
//					+ coffee1.equals(coffee2));
//		System.out.println("coffee2과 coffee3의 해쉬코드가 다르므로 다른 객체: " 
//				+ coffee2.equals(coffee3));
		
		log.error("coffee1과 coffee2의 해쉬코드가 다르므로 다른 객체: {}", coffee1.equals(coffee2));
		log.error("coffee2과 coffee3의 해쉬코드가 다르므로 다른 객체: {}", coffee2.equals(coffee3));
